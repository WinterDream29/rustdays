...
public class AQUAS_LensEffects : MonoBehaviour {
    ...
    public AudioSource airLensAudio;
    ...
    void Start () {
        ...
        if(gameObjects.waterPlanes.Count > 0)
    ...
    void Update () {
        ...
        else
        {
            ...
            else 
            {
                ...
                if (airLensMaterial != null)
                {
                    airLensMaterial.SetFloat("_Refraction",
                        Mathf.Lerp(1, 0, (t - wetLens.wetTime) / wetLens.dryingTime));
                    airLensMaterial.SetFloat("_Transparency",
                        Mathf.Lerp(0.01f, 0, (t - wetLens.wetTime) / wetLens.dryingTime));
                }
            }
            #endregion
