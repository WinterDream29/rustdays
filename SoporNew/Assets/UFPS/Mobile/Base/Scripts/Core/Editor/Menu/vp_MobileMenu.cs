...
public class vp_MobileMenu : Editor
{
	...
	static void AddUIAnchor()
	{
		...
		Undo.RegisterSceneUndo("Create UI Anchor");
	...
	static void AddTouchButton()
	{
		...
		Undo.RegisterSceneUndo("Create Touch Button");
	...
	static void AddTouchLookPad()
	{
		...
		Undo.RegisterSceneUndo("Create Touch Look Pad");
	
		GameObject lookPadGO = new GameObject("LookPadCollider", typeof(vp_UITouchLook));
		lookPadGO.MakeChild();
	...
	static void AddCrosshair()
	{
		...
		Undo.RegisterSceneUndo("Create Crosshair");
	...
	static void AttachSway()
	{
		...
		Undo.RegisterSceneUndo("Attach UI Sway");
	...
	static void AttachCollider()
	{
		...
		Undo.RegisterSceneUndo("Attach Collider");
		Selection.activeGameObject.AddComponent<vp_UISway>();
	...
	static void AttachAnchor()
	{
		...
		Undo.RegisterSceneUndo("Attach Anchor");
	...
	public static void RegisterUndo(string name, params Object[] objects)
	{
		...
		{
			Undo.RegisterUndo(objects, name);
