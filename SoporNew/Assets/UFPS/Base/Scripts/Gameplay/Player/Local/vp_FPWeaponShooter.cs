...
public class vp_FPWeaponShooter : vp_Shooter
{
	...
	protected override void Fire()
	{
	    ...
	    var weapon = _gameManager.Player._currentWeapon.Item as Weapon;
	    if (weapon != null && weapon.AmmoType != null)
	    {
            _gameManager.PlayerModel.Inventory.UseItem(_gameManager, weapon.AmmoType);
            _gameManager.Player.MainHud.UpdateAmmo(m_Player.CurrentWeaponAmmoCount.Get(), weapon.MagazineCapacity);
        }
